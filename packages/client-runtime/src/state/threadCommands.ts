...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    createSession: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:create-session",
      execute: (input: CreateThreadSessionInput) => createThreadSession(input),
      scheduler,
      concurrency,
    }),
  };
